...
def task():
    ...
    pick_position=[rospy.get_param("cube_0_x")-0.01,rospy.get_param("cube_0_y")-0.04,0.03]
    ...
    place_position = [rospy.get_param("cube_1_x")-0.01,rospy.get_param("cube_1_y")-0.04,0.03]
